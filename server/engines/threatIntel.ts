import { ThreatIntelligence, UrlNormalization } from '../types/scanner.ts';
...
async function queryVirusTotal(
  ...
  if (apiKey && apiKey.trim().length > 10) {
    try {
      ...
      // Base64 URL identifier without padding per VT v3 specs
  ...
  // Heuristic mock engine for local testing or when API key is missing
